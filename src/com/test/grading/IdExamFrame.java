...
public class IdExamFrame {
	...
	public static final double Y_MADETHI_STUDENT_PERCENT = 0.0052;
	public static final double W_MADETHI_STUDENT_PERCENT = 0.1739;
	public static final double H_MADETHI_STUDENT_PERCENT = 0.2876;
	...
	public Mat getIDExameFrame(Mat start) {
		...
		int h = (int) (H_MADETHI_STUDENT_PERCENT * start.rows() + 5);
